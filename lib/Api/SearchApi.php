...
class SearchApi
{
     ...
     * Search.
     *
     * @param \RadioManager\Model\SearchDataInput $data Data *(Optional)* (optional)
     * @throws \RadioManager\ApiException on non-2xx response
     * @return void
     */
    public function getSearch($data = null)
    {
        list($response) = $this->getSearchWithHttpInfo($data);
        return $response;
    }
     ...
     */
    public function getSearchWithHttpInfo($data = null)
    {
        // parse inputs
        $resourcePath = "/search";
        $httpBody = '';
